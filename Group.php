...
<div class="page-content">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Welcome to Group</h4>
        </div>
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            ...
            <button type="button" class="btn btn-primary btn-icon-text mb-2 mb-md-0" data-toggle="modal" data-target="#groupModal" data-whatever="@mdo">
                    ...
                    <div class="table-responsive">
                        <table id="dataTableExample" class="table">
                            ...
                            <?php
                                ...
                                $query="SELECT * from a_group order by id desc";
                                        ...
                                        <div class="container mt-4">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="actionDropdown">
                                                        <!-- Dropdown items -->
                                                        <div class="dropdown-item" data-toggle="modal" data-target="#groupEditModal" onclick="editGroup(<?php echo $row['id'] ?>)">Edit</div>

                                                        <div class="dropdown-item" onclick="deleteGroup(<?php echo $row['id'] ?>)">Delete</div>
...
<!--edit group modal -->
<div class="modal fade" id="groupEditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="groupEditModalForm">
                <!--<form>-->
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="updateGroup" onclick="updateGroup()">Edit</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="groupModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary addNewGroup">Add</button>
            </div>
        </div>
    </div>
</div>
...
<script>
 ...
 function editGroup(id){
        ...
        url:"_group.php",
        type:"POST",
        data:{id:id,groupAction:"fetchModal"},
        success:function(data){
            // console.log(data)
            $("#groupEditModalForm").html(data)
        }
        });
        });
    ...
    var editName=document.getElementById("editGroupName").value;

     $(document).ready(function () {
             $.ajax({
        url:"_group.php",
        type:"POST",
        data:{id:editId,name:editName,groupAction:"updateGroup"},
        success:function(data){
            // console.log(data)
            if(data == 1){
   ...
   function deleteGroup(id){
       ...
       window.location.assign("_group.php?id="+id);
        }
    }
    ...
    $(document).ready(function(){
      ...
      $(".addNewGroup").on("click",function(){
          ...
          if(groupName != ''){
             ...
             url:"_group.php",
             type:"POST",
             data:{groupName:groupName,groupAction:"add"},
             success:function(data){
                 console.log(data)
                 if(data == 1){
                     alert("Added Group");
