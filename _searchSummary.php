...
if (isset($_POST['searchMonthWise'])) {

    // if month wise searching 
    if($_POST['searchMonthWise'] == 'monthWise'){
    ...
    // if year wise searching 
     if($_POST['searchMonthWise'] == 'yearWise'){
    ...
    if($_POST['searchMonthWise'] == 'cashCheque'){
...
<tbody id="tableBody">';
    ...
    if (!in_array($project_id, $dublicateProjectArray)) {
        ...
        $totalProjectFeess +=$row['client_amount']; 
       }
    ...
    $html .='</tbody></table>';
    $balanceCount= $totalProjectFeess - $sum;
    echo $html.'!'.number_format($sum).'!'.$dateChart.'!'.$receivingChart.'!'.number_format($totalProjectFeess).'!'.number_format($balanceCount);
}
else{
