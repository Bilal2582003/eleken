...
<div class="page-content">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        ...
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            ...
            <button type="button" class="btn btn-primary btn-icon-text mb-2 mb-md-0" data-toggle="modal" data-target="#serviceModal" data-whatever="@mdo">
                    ...
                    <div class="table-responsive">
                        <table id="dataTableExample" class="table">
                            ...
                            <?php
                                ...
                                $query="SELECT * from a_project_service order by id desc";
                                        ...
                                        <div class="container mt-4">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="actionDropdown">
                                                        <!-- Dropdown items -->
                                                        <div class="dropdown-item" data-toggle="modal" data-target="#serivceEditModal" onclick="editService(<?php echo $row['id'] ?>)">Edit</div>

                                                        <div class="dropdown-item" onclick="deleteService(<?php echo $row['id'] ?>)">Delete</div>
...
<!--edit group modal -->
<div class="modal fade" id="serivceEditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="serivceEditModalForm">
                <!--<form>-->
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="updateService" onclick="updateService()">Edit</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="serviceModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary addNewService">Add</button>
            </div>
        </div>
    </div>
</div>
...
<script>
 ...
 function editService(id){
        ...
        url:"_service.php",
        type:"POST",
        data:{id:id,serviceAction:"fetchModal"},
        success:function(data){
            // console.log(data)
            $("#serivceEditModalForm").html(data)
        }
        });
        });
    ...
    var editId=document.getElementById("editServiceId").value;
    var editName=document.getElementById("editServiceName").value;

     $(document).ready(function () {
             $.ajax({
        url:"_service.php",
        type:"POST",
        data:{id:editId,name:editName,serviceAction:"updateService"},
        success:function(data){
            // console.log(data)
            if(data == 1){
   ...
   function deleteService(id){
       ...
       window.location.assign("_service.php?id="+id);
        }
    }
    ...
    $(document).ready(function(){
      ...
      $(".addNewService").on("click",function(){
          ...
          if(serviceName != ''){
             ...
             url:"_service.php",
             type:"POST",
             data:{serviceName:serviceName,serviceAction:"add"},
             success:function(data){
                 console.log(data)
                 if(data == 1){
                     alert("Added Service");
