...
<div class="page-content" style="max-width:100%">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Reverse Voucher</h6>
                    <h6 class="card-title" class="PaymentModeName">Official</h6>
                    ...
                    <div class="row mt-2 second navigate" id="voucherSecondData" style="border: 1px solid black;padding:20px;border-radius:8px;box-shadow:1px 2px 8px black">
                        <div class="col-sm-12" style="border: 1px solid black;padding:20px;border-radius:8px;box-shadow:1px 2px 8px black; ">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="tdborder" style="width: 40%;">
                                                    <select class="inputBorder e1 desc desc1 mySelectBox navigate">
                            ...
                            <div class="con" style="display: flex;justify-content:flex-start;align-items:flex-start">
                                ...
                                <div class="con1" style="width:90%;background-color:lightgreen;text-align:center;cursor:pointer;" id="addmorerows">Add Row</div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 1; i <= 20; i++) {
                        ...
                        table.append(`<tr>
                        <td class="tdborder">
                          <input disabled class="inputBorder headCode1 bg-white" type="text">
                        </td>

                        <td class="tdborder">
                         <input disabled class="inputBorder accCode1 bg-white" type="text">
                        </td>

                        <td class="tdborder" style="width: 40%;">${select}</td>

                        <td class="tdborder">
                          <input class="inputBorder debit" type="text">
                        </td>

                        <td class="tdborder">
                          <input class="inputBorder credit" type="text">
                        </td>
                        ...
                        <td class="checkboxCenter" style="max-width: 51px;">
                          <input style="width: -webkit-fill-available;" type="text">
                        </td>
                        ...
                        <td style="display:none">
                          <input class="acc_detail_type" type="text">
                        </td>
                        <td style="display:none">
                          <input class="acc_type" type="text">
                        </td>
                        </tr> `);
                    }
